...
export const SourceTooltip: React.FC<SourceTooltipProps> = ({ title, confidence, date, children }) => {
  ...
  return (
    <div className="group relative inline-block">
      {children}
      <div className="absolute bottom-full left-0 mb-2 px-3 py-2 bg-bg-elevated border border-border rounded-lg shadow-lg opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none z-50 w-64">
        ...
        <div className="absolute top-full left-3 w-2 h-2 bg-bg-elevated border-r border-b border-border rotate-45 -mt-1" />
      </div>
    </div>
  );
};
