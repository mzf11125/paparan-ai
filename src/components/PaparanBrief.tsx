      ...
      <div className="max-w-[1920px] mx-auto">
        <div className="flex">
          ...
          <main className="flex-1 min-w-0 max-w-[820px] mx-auto px-6 py-8 lg:px-12">
            ...
            <footer className="mt-12 pt-8 border-t border-border text-center text-sm text-text-tertiary font-ui no-print">
              <p>PaparanBrief — Policy Intelligence · {paparan.date}</p>
              <p className="mt-1">Generated by PaparanBrief — Confidential</p>
            </footer>
          </main>
