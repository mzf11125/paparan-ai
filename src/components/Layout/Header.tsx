...
export const Header: React.FC<HeaderProps> = ({ onCopy, onExport, isCopied }) => {
  return (
    <header className="sticky top-0 z-40 bg-background/95 backdrop-blur-sm border-b border-border px-6 py-4 no-print">
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          <button
            onClick={onCopy}
            className="flex items-center gap-2 px-3 py-1.5 text-sm font-ui text-text-secondary hover:text-text border border-border rounded-lg hover:bg-bg-surface transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-accent/50"
          >
